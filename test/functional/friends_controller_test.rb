...
class FriendsControllerTest < ActionController::TestCase
  ...
  test "should create friend" do
    assert_difference('Friend.count') do
      post :create, friend: { email: @friend.email, name: @friend.name, phone: @friend.phone }
    end
  ...
  test "should update friend" do
    put :update, id: @friend, friend: { email: @friend.email, name: @friend.name, phone: @friend.phone }
    assert_redirected_to friend_path(assigns(:friend))
  end
